...
7. [x] Создать иерархический справочник `Номенклатура` (иерархия групп и элементов) и отнести к `Общее → Справочники`.
...
- [x] Предопределённые элементы `ЕдиницыИзмерения`: ![alt text](./images/LR_2_02.png)
- [x] Реквизиты и форма `Номенклатура`:  
  ![alt text](./images/LR_2_03.png)
- [x] Владелец справочника `Серии`:  
  ![alt text](./images/LR_2_04.png)
- [x] `ФизическиеЛица`: реквизиты + табличная часть + синоним `ФИО`: ![alt text](./images/LR_2_05.png)
- [x] Форма `ФизическиеЛица` (2 страницы): ![alt text](./images/LR_2_06.png) ![alt text](./images/LR_2_07.png)
- [x] Модуль формы (процедура формирования ФИО + обработчики ПриИзменении): ![alt text](./images/LR_2_08.png)
- [x] Командный интерфейс `Общее → Справочники` (видимые команды создания): ![alt text](./images/LR_2_09.png)
- [x] Формы в клиентском интерфейсе 1С:
  Предприятие: ![alt text](./images/LR_2_10.png) ![alt text](./images/LR_2_11.png) ![alt text](./images/LR_2_12.png)
...
3. (В методичке сломана нумерация) Для чего предназначены перечисления и в чем отличие их от справочников?
